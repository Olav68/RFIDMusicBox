...
sudo /bin/systemctl restart rfid_input_listener.service
...
echo "📋 Status for rfid_input_listener:"
sudo /bin/systemctl status rfid_input_listener.service --no-pager